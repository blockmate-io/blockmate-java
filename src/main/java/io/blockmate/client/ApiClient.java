...
import io.blockmate.client.auth.HttpBasicAuth;
import io.blockmate.client.auth.HttpBearerAuth;
import io.blockmate.client.auth.ApiKeyAuth;
...
public class ApiClient {
  ...
  public ApiClient(String[] authNames) {
    ...
    for(String authName : authNames) {
      Interceptor auth;
      if ("ProjectJWT".equals(authName)) {
        
        auth = new HttpBearerAuth("bearer");
        
      } else if ("ProjectToken".equals(authName)) {
        
        auth = new ApiKeyAuth("header", "X-API-KEY");
      } else if ("UserJWT".equals(authName)) {
