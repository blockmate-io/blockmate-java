...
public class AccountProviderHint {
  ...
  **/
  ...
  public AccountProviderHint icon(String icon) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "https://api.blockmate.io/v1/onchain/static/bitcoin.png", required = true, value = "")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountName, accountProviderHint.accountName) &&
        ...
        Objects.equals(this.icon, accountProviderHint.icon);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountName, accountType, accountUrl, description, url, intro, fields, oauth, icon);
  }
